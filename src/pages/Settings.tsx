            ...
            <div className="glass-card-static divide-y divide-berth-border-subtle">
              <div className="px-4 py-3">
                <div className="text-xs text-berth-text-tertiary mb-3">
                  Connect to a NATS server for relay-based agent communication.
                  Use Synadia Cloud or your own NATS server. Not required for
                  direct gRPC connections.
                </div>
                <div className="flex flex-col gap-3">
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-berth-text-tertiary mt-1">
                      .creds file from Synadia Cloud or nsc tool
                    </div>
                  </div>
                </div>
                {settings.nats_url && (
          ...
          <section>
            ...
            <div className="glass-card-static px-4 py-3">
              ...
              <div className="text-xs text-berth-text-secondary mt-0.5">
                v0.4.0 — Deployment control plane for AI-generated code
              </div>
              <div className="text-[10px] text-berth-text-tertiary mt-1">
