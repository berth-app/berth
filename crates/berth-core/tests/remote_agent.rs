...
//! Requires a running berth-agent (set BERTH_TEST_ENDPOINT to override default).

use berth_core::agent_client::AgentClient;
use berth_core::agent_transport::AgentTransport;

fn remote_endpoint() -> String {
    std::env::var("BERTH_TEST_ENDPOINT").unwrap_or_else(|_| "http://localhost:50051".into())
}
