...
const SERVICE_NAME: &str = "com.berth.app";
...
mod tests {
    ...
    fn test_store_get_delete_credential() {
        let key = "berth-test:unit-test-cred";
    ...
    fn test_get_nonexistent_credential() {
        let result = get_credential("berth-test:does-not-exist-xyz-999")
    ...
    fn test_delete_nonexistent_is_ok() {
        let result = delete_credential("berth-test:never-existed-abc-777");
